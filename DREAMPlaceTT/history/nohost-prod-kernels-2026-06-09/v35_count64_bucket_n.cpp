...
//
// V35 count — 64 B SOURCE + FOOTPRINT-BUCKET + NCRISC variant (CBs c_5/c_6). Identical to
// v35_count64_bucket.cpp but on the NCRISC dataflow engine (the dual-RISC half). Histograms
// by group = 2*tile + bucket. Args 10..13 = K0,H0,max_k,max_h.
...
void kernel_main() {
    ...
    constexpr auto CB_IN=tt::CBIndex::c_5, CB_CNT=tt::CBIndex::c_6;
