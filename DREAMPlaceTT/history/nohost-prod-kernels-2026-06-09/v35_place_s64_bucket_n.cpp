...
//
// V35 place — 64 B SOURCE + FOOTPRINT-BUCKET + NCRISC variant (CBs c_5..c_9). Identical to
// v35_place_s64_bucket.cpp but on the NCRISC dataflow engine (dual-RISC half). Sorts by
// group = 2*tile + bucket so each tile's run is small-cells-first then large. Args 13..16 = max_k,max_h,K0,H0.
