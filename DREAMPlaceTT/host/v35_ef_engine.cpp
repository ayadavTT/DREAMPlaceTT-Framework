...
void V35EFEngine::compute_from_chip(uint32_t fx_addr,uint32_t fy_addr,float* grad,V35Timing* t){
    ...
    if(!I.built){
        ...
        I.grouped_pg=(uint32_t)((uint64_t)na*128u+128u); I.out_pg=I.mc*4u; I.field_pg=(uint32_t)((uint64_t)NBY*4u);
    ...
    EnqueueReadMeshBuffer(*I.cq,I.gradx,I.gxb,true); EnqueueReadMeshBuffer(*I.cq,I.grady,I.gyb,true); EnqueueReadMeshBuffer(*I.cq,I.oidx_host,I.oibb,true);
